...
public class C03_ZeroWebapp {
    public static void main(String[] args) throws InterruptedException {
      ...
      //  3. Login alanine  “username” yazdirin
        ...
        WebElement paymentGorunumTest= driver.findElement(By.id("alert_content"));

        if (paymentGorunumTest.isDisplayed()) {
            System.out.println("The Payment Succesfully Gorunum Testi : PASSED");
        } else {
            System.out.println("The Payment Succesfully Gorunum Testi : FAILED");
        }
